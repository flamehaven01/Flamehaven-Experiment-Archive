...
This copy supersedes the previous `0058` (output_hash `69c97c92`) with `1498610f`, produced at committed source `c0f6c6a`. The only **numerical** change is R0.1; the rest is provenance/presentation:
